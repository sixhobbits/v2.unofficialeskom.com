...
![Energy availability factor, monthly average](./img-eaf.png)
*EAF climbs for a third month to 66.8%, tracking the seasonal maintenance wind-down.*

![Capability loss factors, monthly average MW](./img-clf.png)
...
![Nuclear generation, monthly average MW](./img-nuclear.png)
...
![OCGT average (bars) and peak (line) per month, MW](./img-ocgt.png)
...
![OCGT output every hour of June 2026](./img-ocgt-june.png)
...
![Demand by year, monthly average MW](./img-demand.png)
...
![Imports and exports, monthly average MW](./img-trade.png)
...
![Demand reduction — monthly peak by tool, MW](./img-reduction-max.png)
